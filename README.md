...
- [LuisCore Chorus Field](https://github.com/luisprimecore/chorus-field-mcp) — Open agent bootstrap + MCP (`npx @luiscore/chorus-field@latest`); live server https://luiscore.com/mcp
